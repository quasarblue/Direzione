...
public interface ProgrammaLavoriRepository extends PagingAndSortingRepository<ProgrammaLavori, Integer> {
	...
	@Query(value = "SELECT * " 
			     ...
			     + "  FROM programma_lavori a, funzionario_appalto fa, dipendente d, appalto ap "
